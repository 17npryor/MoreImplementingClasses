...
class Baby(object):
    def __init__(self, name1):
        self.name1 = name1
        print("Hello Baby " + self.name1)
        self.hour1 = 0

    def feed_baby(self):
        print("Thank you for feeding Baby " + self.name1)
        self.hour1 = 0

    def hour_passes(self):
        if self.hour1 == 0:
            print("Baby " + self.name1 + " is sleeping")
        elif self.hour1 == 1:
            print("Baby " + self.name1 + " is awake. Time for food.")
        else:
            print("Baby " + self.name1 + " is CRYING uncontrollably! Feed the "
                                       "baby!")

        self.hour1 = self.hour1 + 1
